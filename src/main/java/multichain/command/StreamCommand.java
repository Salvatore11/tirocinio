...
public class StreamCommand extends QueryBuilderStream {
	...
	public String create(String streamName) throws MultichainException {
        ...
        public StreamKeyItem getStreamItem(String streamname,String txid,boolean verbose){
            ...
            try {
                ...
                System.out.println("Sono in Stream Command, stampo obj: " + obj.toString());
            } catch (MultichainException ex) {
                Logger.getLogger(StreamCommand.class.getName()).log(Level.SEVERE, null, ex);
            }
	...
	public List<StreamKey> listStreamKeys(String streamName) throws MultichainException {
		return listStreamKeys(streamName, "*", false, Integer.MAX_VALUE);
	}
	...
	// Stream list with txid
	@SuppressWarnings("unchecked")
	public List<StreamKeyTxid> listStreamItemsTxid(String streamName, boolean verbose, int count)
			throws MultichainException {
		List<StreamKeyTxid> streamKeyTxid = new ArrayList<StreamKeyTxid>();

		Object objectStreamKeyTxid = executeListStreamItems(streamName, verbose, count);
		if (verifyInstance(objectStreamKeyTxid, ArrayList.class)
				&& verifyInstanceofList((ArrayList<Object>) objectStreamKeyTxid, StreamKeyItem.class)) {
			streamKeyTxid = StreamFormatter.formatStreamKeyTxid1((ArrayList<Object>) objectStreamKeyTxid);
		}

		return streamKeyTxid;
	}
	...
	public List<StreamKeyItem> listStreamItems(String streamName) throws MultichainException {
		return listStreamItems(streamName, false, 100);
	}
	...
	// publish con JSON
	public String publishObject(String streamName, String key, JSONObject obj2) throws MultichainException {
		String stringPublish = "";

		Object objectPublish = executePublishObject(streamName, key, obj2);
		if (verifyInstance(objectPublish, String.class)) {
			stringPublish = objectPublish.toString();
		}
