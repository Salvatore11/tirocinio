...
public class QueryBuilderStream extends QueryBuilderCommon {
	...
	protected Object executePublishObject(String streamName, String key, JSONObject obj2) throws MultichainException {
		MultichainTestParameter.isNotNullOrEmpty("streamName", streamName);
		MultichainTestParameter.isNotNullOrEmpty("key", key);
		MultichainTestParameter.isNotNull("dataHex", obj2);

		return execute(CommandEnum.PUBLISH, streamName, key, obj2);
	}
